...
const adaptive = {
    ...
    purpose: "Staffing Company",
};
const suddenlink = {
    name: "Suddenlink",
    purpose: "Telecommunications Company",
};
...
const organizations = [att, fed, adaptive];
...
const ibmAsm = bz("IBM ASM", [
    bz("assembly language"),
    mainframe,
    programmingLanguage,
]);
...
const cicd = bz("Continuous Integration/Continuous Deployment", [
    bz("CI/CD"),
    devOps,
]);
...
const stno = bz("Serverless Transit Network Orchestrator", [
    aws,
    vpc,
    transitGateway,
    serverless,
...
const dataDog = bz("DataDog", [observability]);
...
const mts = {
    name: "MTS",
    organization: fed,
    buzzwords: [springDataJpa, java, junit],
};
const brs = {
    name: "BRS",
    organization: fed,
...
const btm = {
    name: "BTM",
    organization: fed,
    buzzwords: [jsf, spring, hibernate, weblogic, python, java, junit],
};
const cars = {
    name: "CARS",
    organization: fed,
    buzzwords: [j2ee, weblogic, python, java, junit],
};
...
const tenures: Tenure[] = [
    ...
    },
    {
        ...
        buzzwords: [
            ...
            ksh,
            plSql,
            bz("Motive Model and Overlay Builder"),
            bz("Motive Workflow Builder"),
            bz("Motive Workflow Engine"),
        ],
    },
